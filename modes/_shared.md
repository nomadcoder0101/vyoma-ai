...
| Domain specificity in JD | JD text | Medium | Generic JDs correlate with ghost postings but also with poor writing |
...
|-----------|-------------------|
| Financial Crime Compliance | "AML", "financial crime", "FCC", "AFC", "regulatory compliance", "AML/CFT" |
| Transaction Monitoring / Investigations | "transaction monitoring", "alerts", "investigation", "typologies", "red flags", "case management" |
| SAR/STR/SMR Reporting | "SAR", "STR", "SMR", "suspicious activity", "suspicious transaction", "regulatory reporting" |
| KYC / CDD / EDD | "KYC", "CDD", "EDD", "ECDD", "onboarding", "periodic review", "source of funds", "source of wealth" |
| Sanctions / PEP / Adverse Media | "sanctions", "PEP", "adverse media", "screening", "World-Check", "LexisNexis" |
| Risk, QA, and Remediation | "quality assurance", "checker", "audit", "risk rating", "remediation", "control" |
...
8. Native financial services compliance English for generated text. Short sentences, action verbs, no passive voice.
